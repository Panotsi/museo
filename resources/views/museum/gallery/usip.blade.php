...
<head>
    ...
    <title>Usip</title>
    <link rel="stylesheet" href="{{ asset('css/gallery/usip.css') }}">
</head>
<body>
    <header>
        <h1>USIP</h1>
        <p>Stories and Myths in Agriculture</p>
    </header>
    <main>
        <div class="container1">
            <div class="con1">
                <p>delves into the rich tapestry of Bicolano 
                    agriculture, exploring its deep-rooted connection 
                    to mythology and folklore. 
                </p>
                <p>showcase rituals and beliefs surrounding 
                    farming and rice cultivation.
                </p>
                <p>
                    highlights the significance of rice in the Bicolano
                    identity. 
                </p>
            </div>
            <div class="con2">
